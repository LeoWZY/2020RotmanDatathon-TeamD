...
##2.2 pick top 5 shooters in Canadian Women team
```{r}
...
##3.2 pick top 5 shooters in Canadian Women team
```{r}
...
#4. Pick the player that is significantly dominant in competitions
```{r}
